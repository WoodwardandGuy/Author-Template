              ...
              {events.map((event) => {
                ...
                return (
                  <li key={event.id} className="py-6 flex flex-col sm:flex-row sm:items-start gap-4">
                    <div className="flex items-center gap-2 text-brand-light font-medium shrink-0 sm:w-56">
                    ...
                    <div className="flex-1">
                      ...
                      {event.url && (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-bone font-medium text-sm mt-2 hover:text-brand-light transition-colors"
                        >
                          Details
